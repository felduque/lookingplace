...
<div style="border: 4px solid #0099CC; border-radius: 10px; padding: 20px; max-width: 500px; margin: auto; font-family: Arial, sans-serif; font-size: 16px; line-height: 1.4; color: #333;">
  ...
  <p>Se ha realizado con exito la publicacion de una nueva propiedad</p>
  <p>Gracias por confiar en LookingPlace.</p>
  <div style="text-align: center; margin: 20px 0;">
    <a href="http://127.0.0.1:5173/login" style="background-color: #0099CC; color: #fff; padding: 10px 20px; border-radius: 5px; text-decoration: none;">Publica nuevas propiedades</a>
  </div>
